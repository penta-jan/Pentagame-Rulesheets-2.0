...
\tikzstyle{state}=[circle, draw, inner sep=3pt, opacity=1, fill=black, minimum size=0.6pt]
\tikzstyle{empty}=[circle, draw, inner sep=3pt, opacity=0, fill=white, minimum size=0.6pt]
